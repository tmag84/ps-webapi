namespace PS_project.Utils.DB
{
    public class DB_QueryStrings
    {
        ...
        public const string UPDATE_SERVICE_INFO = "update service set name=@serv_name,description=@description,contact_number=@c_num,contact_name=@c_name,contact_location=@c_loc where provider_email=@prov_email";
